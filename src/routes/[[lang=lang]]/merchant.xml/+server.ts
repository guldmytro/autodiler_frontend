    ...
    return new Response(`
        ...
        <rss version="2.0" xmlns:g="http://base.google.com/ns/1.0">
            <channel>
                ...
                <description>
                    ${locale === 'uk' ?
                        'Надійний Інтернет-магазин автозапчастин «АВТО-ДІЛЕР»  🚙 Ціни від виробника. На сайті автозапчастин Ви можете купити автозапчастини оптом та вроздріб: оригінальні деталі для іномарок, китайців та ВАЗ'
                        : 
                        'На нашем сайте автозапчастей Вы можете купить оригинальные детали для иномарок, китайцев и ВАЗ ✔️ Широкий ассортимент ⚡ Выгодные цены ⭐ Гарантия'
                    }
                </description>
                ${urls}
            </channel>
