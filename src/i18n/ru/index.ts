...
const ru = {
	...
	checkout: {
		...
		'paynowError': 'Заказы до 200грн принимаются по полной предоплате',
	},
	checkoutErrors: {
	...
	search: {
		title: 'Быстрый поиск:',
		title2: 'выберите марку или раздел',
		model: {
			title: 'Модель',
	...
	contacts: {
		...
		schedule: 'пн-пт с 9:00 по 18:00 <br> сб - с 9:00 по 15:00 <br> вс - выходной'
	},
	faq: {
	...
	headerSearch: {
		button: 'Поиск',
		submit: 'Найти',
		placeholder: 'Поиск по номеру запчасти, производителю, наименованию...'
	},
	ds: {
		takeOffer: {
			title: 'Заполните форму',
	...
	scheduleWarn: '⚠️ Вы оформляете заказ в нерабочее время. Мы&nbsp;возьмем&nbsp;в&nbsp;работу Ваш&nbsp;заказ&nbsp;<strong>[when]</strong>.',
