...
const uk = {
	...
	checkout: {
		...
		'paynowError': 'Замовлення до 200грн приймаються по повній передоплаті',
	},
	checkoutErrors: {
	...
	search: {
		title: 'Швидкий пошук:',
		title2: 'виберіть марку або розділ',
		model: {
			title: 'Модель',
	...
	contacts: {
		...
		schedule: 'пн-пт з 9:00 до 18:00 <br> сб - з 9:00 до 15:00 <br> нд - вихідний'
	},
	faq: {
	...
	account: {
		...
		failed: {
			...
			p: 'Не вдалось активувати аккаунт. Можливо Ви його уже активували раніше.',
		}
	},
	create: {
		errors: {
	...
	ds: {
		takeOffer: {
			title: 'Заповніть форму',
			subtitle: 'Та отримайте спеціальний пакет обслуговування нових клієнтів',
			name: 'Ваше ім\'я',
			phone: 'Ваш телефон',
			city: 'Ваше місто',
			submit: 'Відправити',
			clientTypes: [
				"Представником якого бізнесу ви є?",
				"Магазин автозапчастин",
				"СТО",
				"Онлайн-магазин",
				"Торгова точка на ринку",
				"Компанія оптової та роздрібної торгівлі",
				"Автобаза",
				"Компанія із власним автопарком"
			],
			productTypes: [
				"Які товари вас цікавлять?",
				"Запчастини від топових брендів",
				"Мастила",
				"Автохімія",
				"Обладнання для СТО"
			],
			errors: {
				clientType: {required: 'Виберіть із списку'},
				productType: {required: 'Виберіть із списку'},
		...
		main: {
			title: 'Оптовий продаж<br/> автозапчастин',
			button: 'Стати партнером',
		},
		stats: [
			'<strong>Більше 100 тис.</strong> позицій автокомпонентів', 
			'<strong>20 років</strong> на ринку автозапчастин України', 
			'<strong>Офіційна гарантія</strong> якості продукції', 
			'Відстрочка платежу чи <strong>поетапна оплата</strong>'
		],
		list: {
			title: 'Ексклюзивні торгові марки по найвигіднішим цінам',
			features: [
				'Персональний менеджер, консультації та допомога з підбором запчастин',
				'Можливість обміну та повернення товару',
				'Гарантія на запчастини від виробника',
				'Відстрочка платежу',
				'Швидка та зручна доставка замовлень',
			]
		},
		feadback: {
			title: 'Отримайте прайс-лист для партнерів',
