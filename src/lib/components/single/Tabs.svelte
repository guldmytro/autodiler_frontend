...
<nav class="product-tabs">
    <a href="/{localePrefix}product-cat/{product.term_slug}/{product.slug}" class="product-tabs__link"
        class:product-tabs__link_active={!pageURL.includes('/params')}>Про товар</a>
    {#if Array.isArray(product.params) && product.params.length}
        <a href="/{localePrefix}product-cat/{product.term_slug}/{product.slug}/params" class="product-tabs__link"
